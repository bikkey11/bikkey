...
const ReviewsCard = ({ review,limit }) => {
    ...
    return (
        <div className='text-navText bg-card shadow-sm shadow-navText p-8 rounded-2xl relative max-w-[300px]  '>
...
const Testinomial = () => {
    ...
    return (
        <div className='sm:mx-10 md:mx-32 my-20 bg-reviewCard  p-6  rounded-2xl'>
            <div className='flex flex-col justify-between gap-2 items-center'>
                <h1 className='text-white text-[48px] leading-[48px] xs:text-[60px] xs:leading-[60px] font-black font-poppins'> Testimonials</h1>
                <span className='xs:text-xl text-base font-semibold font-poppins text-navText'>Hear What Our Customers Have to Say</span>
            </div>
