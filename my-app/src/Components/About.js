    ...
    return (
        <div className='flex flex-col flex-wrap '>
            <div className='md:mx-32 mx-10'>
                <h1 className='font-poppins text-navText text-[26px] xs:text-[30px] font-medium leading-[40px]'>Introduction</h1>
                <h2 className='xs:leading-[80px] font-poppins font-black text-white text-[60px] xs:text-[80px] leading-[60px] '>Overview.</h2>
                <p className='mt-4 text-navText xs:text-[17px] text-sm max-w-3xl font-Chakra_Petch'> I'm a skilled web developer with experience in Javascript and expertise in framework like React, Node.js, Three.js. Have good knowledge of database like MySQL, MongoDB, Firebase. I'm a quick learner and collaborate closely with client to create efficient, scalable, and user friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!</p>
            </div>
